...
INSERT INTO `expenses` VALUES (1,'units_amount',18800),(2,'rental_amount',8000),(3,'avail_amount',10800);
...
INSERT INTO `units` VALUES (1,'Unit 101','available',1800.00,NULL,NULL),(2,'Unit 102','rented',2000.00,1,'2024-03-01'),(3,'Unit 103','available',1800.00,NULL,NULL),(4,'Unit 104','available',1800.00,NULL,NULL),(5,'Unit 105','rented',2000.00,2,'2024-03-15'),(6,'Unit 106','rented',2000.00,3,'2024-03-20'),(7,'Unit 107','available',1800.00,NULL,NULL),(8,'Unit 108','available',1800.00,NULL,NULL),(9,'Unit 109','available',1800.00,NULL,NULL),(10,'Unit 110','rented',2000.00,4,'2024-03-25');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_rent_amount` BEFORE INSERT ON `units` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_unit_insert` AFTER INSERT ON `units` FOR EACH ROW BEGIN
    -- Update status in related rented_units view if unit is rented
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_rent_amount` AFTER INSERT ON `units` FOR EACH ROW update expenses
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_update_rent_amount` BEFORE UPDATE ON `units` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_unit_update` AFTER UPDATE ON `units` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_update_rent_amount` AFTER UPDATE ON `units` FOR EACH ROW update expenses
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_unit_delete` AFTER DELETE ON `units` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_delete_rent_amount` AFTER DELETE ON `units` FOR EACH ROW update expenses
...
INSERT INTO `users` VALUES (1,'cedric','rentuaya','cedric@gmail.com','cedric','rentuaya',0),(2,'admin','admin','admin2@gmail.com','admin','admin',0),(3,'marlon','marlon','marlon@gmail.com','marlon','orpiada',0),(5,'bhemz10','rentuaya','cedricrentuaya@gmail.com','Ceddy','Rentuaya',0);
...
-- Dump completed on 2024-04-14 18:16:52
